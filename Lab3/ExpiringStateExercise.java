...
public class ExpiringStateExercise extends ExerciseBase {
	// Теги для вывода необработанных поездок и чаевых
	...
	public static void main(String[] args) throws Exception {
		...
		final int servingSpeedFactor = 600;    // 10 минут событий подаются за 1 секунду
		...
		// Источник данных поездок с фильтрацией и группировкой по rideId
		...
		// Источник данных чаевых с группировкой по rideId
	...
	public static class EnrichmentFunction extends KeyedCoProcessFunction<Long, TaxiRide, TaxiFare, Tuple2<TaxiRide, TaxiFare>> {
		...
		private ValueState<TaxiFare> fareState; // Состояние для хранения чаевых
		...
		// Обработка истечения времени ожидания события
		@Override
